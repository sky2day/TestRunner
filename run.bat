@ECHO OFF
::========================================
SET GITHUB_ACCOUNT=sky2day
SET WS_DIR=Workspace
SET REPO_NAME=Title_Validation_CSV
SET APP_VERSION=1.1
SET MAIN_CLASS=core.SeleniumCSV
SET ARGS_01=
::========================================
...
java -jar C:\%WS_DIR%\%REPO_NAME%\target\%REPO_NAME%-%APP_VERSION%-jar-with-dependencies.jar %MAIN_CLASS% %ARGS_01%
GOTO END
